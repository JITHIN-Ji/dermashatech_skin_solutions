...
const Microneedling = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-white">
      ...
      {/* NEW SECTION - Professional Microneedling Devices */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              {/* Decorative Element */}
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-cyan-200 to-teal-200 rounded-full blur-3xl opacity-30"></div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="inline-block px-4 py-2 bg-[#E0F7FA] rounded-full">
                <p className="text-sm font-semibold text-[#00838F]">Why Choose Us</p>
              </div>
              
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Experience Professional-Grade Microneedling Technology
              </h2>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Our carefully curated collection of microneedling devices is designed to deliver exceptional results for professional aesthetic treatments. Each device is engineered with precision to provide safe, effective, and customizable skin rejuvenation solutions.
              </p>
              
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-[#B2EBF2] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Check className="w-4 h-4 text-[#00838F]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Professional Grade</h3>
                    <p className="text-gray-600">All devices meet professional standards for clinical and aesthetic use</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Featuring cutting-edge features like LED therapy, microcurrent, and adjustable depth</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Clinically tested devices that deliver visible improvements in skin texture and appearance</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4">
                <a
                  ...
                  className="inline-block px-8 py-4 bg-[#B2EBF2] text-gray-800 font-semibold rounded-xl shadow-md hover:shadow-lg hover:bg-[#80DEEA] transition-all duration-300"
                >
