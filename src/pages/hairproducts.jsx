...
const HairProducts = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-white">
      ...
      <section className="relative py-4 sm:py-5 md:py-8 bg-gradient-to-br from-[#F0F9FF] via-[#E0F2FE] to-[#BAE6FD] overflow-hidden min-h-[180px] sm:min-h-[220px] md:min-h-0">
        {/* Subtle Background Pattern */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 right-0 w-96 h-96 bg-blue-200 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-cyan-200 rounded-full blur-3xl"></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-4 md:gap-6 items-center">
            ...
            >
              ...
              <p className="text-xs sm:text-sm md:text-base text-gray-700 leading-relaxed">
                Discover our premium collection of hair care essentials designed for healthy, strong, and beautiful hair
              </p>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-3 gap-2 md:gap-3 h-36 sm:h-40 md:h-48">
                {/* Placeholder for hair product images */}
              </div>

              {/* Subtle Floating Elements */}
              <div className="absolute -top-2 -right-2 w-12 h-12 bg-gradient-to-br from-blue-200 to-cyan-200 rounded-full blur-xl opacity-30 animate-pulse"></div>
              <div className="absolute -bottom-2 -left-2 w-16 h-16 bg-gradient-to-br from-cyan-200 to-blue-200 rounded-full blur-xl opacity-30 animate-pulse" style={{ animationDelay: '1s' }}></div>
            </motion.div>
          </div>
        </div>
      </section>
